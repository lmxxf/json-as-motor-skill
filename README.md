...
| [dual-layer-empirical-en.md](dual-layer-empirical-en.md) | **English paper 英文论文** |
| [dual-layer-empirical-en.pdf](dual-layer-empirical-en.pdf) | **English paper PDF 英文论文 PDF**（Zenodo 版） |
...
| [generate_figures.py](generate_figures.py) | Generate paper figures (1-4) 生成论文图表（1-4） | matplotlib, numpy |
| [figure5_cross_model_comparison.py](figure5_cross_model_comparison.py) | Generate figure 5 (cross-model) 生成图5（跨模型对比） | matplotlib |
